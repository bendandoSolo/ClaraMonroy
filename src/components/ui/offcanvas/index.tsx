            ...
            <AnimatePresence initial={false}>
                {isOpen && (
                    <motion.div
                        ...
                        exit="close"
                    >
                        {/* tw-bg-[url('/images/bg/mobile-bg.jpg')] */}
                        <motion.div
                            className={clsx(
                                "tw-relative tw-z-30 tw-w-[300px] tw-ml-auto sm:tw-w-[360px] tw-h-full tw-bg-secondary  tw-bg-no-repeat tw-bg-top tw-bg-cover",
